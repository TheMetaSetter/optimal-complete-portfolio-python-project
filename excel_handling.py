...
def export_portfolio_to_xlsx(portfolio: portfolio_characteristics.portfolio, path = 'OPTIMAL_COMPLETE_PORTFOLIO.xlsx'):
    # Create an Excel writer object using a context manager
